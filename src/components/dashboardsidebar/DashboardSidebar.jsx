...
const DashboardSidebar = ({ isMenuOpen }) => {
  ...
  const handleUserList = () => {
    router.push(createLocalizedPath("/dashboard/userslist", pathname));
  };
  ...
  const handleJobList = () => {
    router.push(createLocalizedPath("/dashboard/jobs", pathname));
  };

  const handleProductList = () => {
    router.push(createLocalizedPath("/dashboard", pathname));
  };

  const handleCouponsList = () => {
    router.push(createLocalizedPath("/dashboard/couponslist", pathname));
  };
          ...
          <ul className="space-y-4">
            ...
            <li>
              <button
                onClick={() => {
                  router.push(
                    createLocalizedPath("/dashboard/notes", pathname)
                  );
                }}
